...
let footballarr=require('./Route/football');
...
app.use("/sport/cricket/insert", cricket)
...
app.use("/sport/football/insert", football);
...
{   let data=req.body ;
    res.send(data,footballarr);
    // let newfootballarr=footballarr.concat(data);
    // res.send(newfootballarr);
});
